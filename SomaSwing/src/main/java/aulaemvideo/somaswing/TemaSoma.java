 ...
 */
package aulaemvideo.somaswing;

/**
 *
 * @author ricardopitanga
 */
public class TemaSoma extends javax.swing.JFrame {

    /**
     * Creates new form TemaSoma
     */
    public TemaSoma() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TemaSoma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
